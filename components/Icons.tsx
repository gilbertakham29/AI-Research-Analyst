...
export const IconGraph = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="3"/><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="18" r="3"/><line x1="8.7" x2="15.3" y1="8.7" y2="15.3"/><line x1="8.7" x2="15.3" y1="15.3" y2="8.7"/><line x1="15.3" x2="8.7" y1="6" y2="6"/><line x1="15.3" x2="8.7" y1="18" y2="18"/></svg>
);
